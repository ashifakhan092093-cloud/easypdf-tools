  ...
  return (
    <main className={`page ${mounted ? "page--mounted" : ""}`}>
      ...
      <section className="hero">
        ...
        {/* ✅ SEO INTERNAL LINKS (new) */}
        <div className="seo-links">
          <Link href="/merge-pdf-online" className="seo-link">
            Merge PDF Online
          </Link>
          <span className="seo-dot">•</span>
          <Link href="/compress-pdf-online" className="seo-link">
            Compress PDF Online
          </Link>
          <span className="seo-dot">•</span>
          <Link href="/pdf-to-jpg-online" className="seo-link">
            PDF to JPG Online
          </Link>
          <span className="seo-dot">•</span>
          <Link href="/jpg-to-pdf-online" className="seo-link">
            JPG to PDF Online
          </Link>
        </div>
      </section>
