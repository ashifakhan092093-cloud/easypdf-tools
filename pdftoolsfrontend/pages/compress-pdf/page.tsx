...
export default function CompressPdfPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // backend commonly expects "file"
      formData.append("file", file);
      // optional: if backend supports compression level
      ...
      if (!res.ok) {
        ...
        throw new Error(text || "Failed to compress PDF.");
      }
      ...
      setSuccessMsg("✅ Compressed PDF downloaded. Check your Downloads folder.");
    } catch (err: any) {
      console.error(err);
      setError(err?.message || "Something went wrong while compressing PDF.");
    } finally {
    ...
    <main className="page page--inner">
      ...
      <section className="hero">
        <h1 className="hero-title">
          Compress <span className="hero-title-green">PDF</span> file
        </h1>
        <p className="hero-desc">
          Reduce your PDF size for sharing, uploading, and faster downloads.
        </p>
      </section>
      ...
      <section className="tool-wrapper">
        <div className="tool-main-card">
          ...
          <p className="tool-main-subtitle">
            Choose compression level and download the optimized PDF.
          </p>
          ...
          <form className="upload-form" onSubmit={handleSubmit}>
            ...
            <div className="level-card">
              <div className="level-title">Compression level</div>
              <div className="level-grid">
                <label className={`level-pill ${level === "low" ? "active" : ""}`}>
                  <input
                    type="radio"
                    name="level"
                    value="low"
                ...
                <label
                  className={`level-pill ${level === "medium" ? "active" : ""}`}
                >
                  <input
                    type="radio"
                    name="level"
                ...
                <label
                  className={`level-pill ${level === "high" ? "active" : ""}`}
                >
                  <input
                    type="radio"
                    name="level"
              ...
              <div className="level-note">
                Note: If your backend doesn’t use “level”, it will safely ignore it.
              </div>
            </div>
            ...
            {downloadUrl && (
              <div className="download-box">
                <div className="download-title">Your compressed PDF is ready:</div>
                <a
                  href={downloadUrl}
        ...
        <aside className="side-card">
          ...
          <ul className="side-list">
            <li>High compression makes files smaller but may reduce quality.</li>
            <li>Try Medium first for best balance.</li>
            <li>Compressed PDF downloads automatically.</li>
          </ul>
        </aside>
      </section>
      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <span>Compress PDFs safely in your browser.</span>
        </div>
      </footer>
