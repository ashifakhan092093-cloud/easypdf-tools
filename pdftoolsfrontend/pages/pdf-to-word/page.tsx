  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(text || "Failed to convert PDF to Word.");
      }
      ...
      setSuccessMsg("✅ Word file downloaded. Check your Downloads folder.");
    } catch (err: any) {
      console.error(err);
    ...
    <main className="page page--inner">
      ...
      <section className="hero">
        <h1 className="hero-title">
          PDF to <span className="hero-title-green">Word</span>
        </h1>
        <p className="hero-desc">
          Convert your PDF into an editable Word (.docx) file.
        </p>
      </section>
      ...
      <section className="tool-wrapper">
        <div className="tool-main-card">
          ...
          <p className="tool-main-subtitle">
            Choose a PDF and download the converted Word document.
          </p>
          ...
          <form className="upload-form" onSubmit={handleSubmit}>
            ...
            {downloadUrl && (
              <div className="download-box">
                <div className="download-title">Your Word file is ready:</div>
                <a
                  href={downloadUrl}
        ...
        <aside className="side-card">
          ...
          <ul className="side-list">
            <li>Scanned PDFs may convert with less accuracy.</li>
            <li>Large PDFs can take more time.</li>
            <li>File downloads automatically after conversion.</li>
          </ul>
        </aside>
      </section>
